...
var (
	...
	_ = ioutil.NopCloser
	_ = pb.NewGitContributionsDrawClient
	_ = io.Copy
	_ = errors.Wrap
)
...
func RegisterHttpHandler(router *mux.Router, endpoints Endpoints, tracer trace.Tracer, logger log.Logger) {
	...
	router.Methods("GET").Path("/git-contribution-draw/v1/contributions/{name}").Handler(
		httptransport.NewServer(
			endpoints.GetDrawEndpoint,
			DecodeHTTPGetDrawRequest,
...
// DecodeHTTPGetDrawRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded getdraw request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPGetDrawRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.GetDrawRequest
	...
	err = unmarshalPathParam(pathParams, &req.Name, "name")
